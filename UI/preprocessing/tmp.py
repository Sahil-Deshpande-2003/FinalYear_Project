import sys
mesonet_repo_path = "/kaggle/input/mesonet/"
sys.path.append(mesonet_repo_path)
import traceback
import contextlib
...
classifier.load('/kaggle/input/mesonet/weights/MesoInception_DF.h5') # change!!!

real_video_dir = "/kaggle/input/resize-dataset/resize_original_data/youtube/c23/"
real_vid_list = os.listdir(real_video_dir)
real_vid_list.sort()
real_vid_dict = {x:real_video_dir + x for x in real_vid_list}

fake_video_dir = "/kaggle/input/resize-dataset/resize_f2f_all/"
...
fake_mit_dir = "/kaggle/working/stmap-f2f-all1000/"
fake_mit_list = os.listdir(fake_mit_dir)
fake_mit_list.sort()
fake_mit_dict = {x:fake_mit_dir + x + '/' + x + '.npy' for x in fake_mit_list}

real_mit_dir = "/kaggle/input/stmap-data/dfdc_orig/stmap/"
...
save_path = "/kaggle/working/df_ytb_c23/"
